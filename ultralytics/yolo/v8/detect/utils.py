...
def coco_summarize(self):
    ...
    def _summarizeDets():
        ...
        stats[5] = _summarize(1, areaRng='small',
                              maxDets=self.params.maxDets[2])
        stats[6] = _summarize(1, areaRng='medium',
                              maxDets=self.params.maxDets[2])
        stats[7] = _summarize(1, areaRng='large',
                              maxDets=self.params.maxDets[2])
        ...
        stats[11] = _summarize(0, areaRng='small',
                              maxDets=self.params.maxDets[2])
        stats[12] = _summarize(0, areaRng='medium',
                               maxDets=self.params.maxDets[2])
        stats[13] = _summarize(
